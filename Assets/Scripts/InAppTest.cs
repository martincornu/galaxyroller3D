...
public class InAppTest : MonoBehaviour, IStoreListener
{
    ...
    private static string kProductNameGooglePlayConsumable = "com.martinc.galaxyroller3d.get1500";        // Google Play Store identifier for the consumable product.
    ...
    private static string myNewProductGoogle = "com.martinc.galaxyroller3d.get3500";
