...
public class InAppTestMore : MonoBehaviour, IStoreListener
{
    ...
    private static string myNewProduct = "newProduct";
    ...
    private static string myNewProductApple = "newProductAppleStore";

    private static string kProductNameGooglePlayConsumable = "com.martinc.galaxyroller3d.get3500";        // Google Play Store identifier for the consumable product.
    ...
    private static string myNewProductGoogle = "com.martinc.galaxyroller3d.get1500";

    private static string kProductNameWindowsConsumable = "dezubfequb";
    private static string myNewProductWindows = "newProductWindowsStore";
    ...
    public void InitializePurchasing()
    {
        ...
        builder.AddProduct(kProductIDConsumable, ProductType.Consumable, new IDs() { { kProductNameAppleConsumable, AppleAppStore.Name }, { kProductNameGooglePlayConsumable, GooglePlay.Name }, { kProductNameWindowsConsumable, WindowsPhone8.Name }, });// Continue adding the non-consumable product.
        ...
        builder.AddProduct(myNewProduct, ProductType.Consumable, new IDs() { { myNewProductApple, AppleAppStore.Name }, { myNewProductGoogle, GooglePlay.Name }, { myNewProductWindows, WindowsPhone8.Name }, });// Continue adding the non-consumable product.
    ...
    public void BuyMyProduct()
    {
        BuyProductID(myNewProduct);
    }
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        ...
        if (String.Equals(args.purchasedProduct.definition.id, kProductIDConsumable, StringComparison.Ordinal))
        {
            ...
            GameManager.Instance.currency += 225;
            GameManager.Instance.Save();

        }
        else if (String.Equals(args.purchasedProduct.definition.id, myNewProduct, StringComparison.Ordinal))
        {
            Debug.Log("My new product was successfully purchased !!");
        }
